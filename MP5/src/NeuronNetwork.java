...
class Neuron {
    ...
    private int fireCount = 0;  // number of times this neuron as fired
    ...
    void fire(float time) {
        ...
        //System.out.println( String.format("%.2f", time) + " neuron " + name + " fired");
        this.voltage = 0.0f;
...
public class NeuronNetwork {
     ...
     */
    static void initializeNetwork( Scanner sc ) throws Neuron.IllegalNameEx {
        while (sc.hasNext()) {
     ...
     * @see printNetwork
     */
    public static void main(String[] args) throws Neuron.IllegalNameEx {
        /*if (args.length < 1) {
